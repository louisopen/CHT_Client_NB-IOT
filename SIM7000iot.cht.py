...
def connect_mqtt():
    ...
    print(receiving(ser))
    ser.write('AT+SMCONF="USERNAME","DKERAFHA5AUPXX335F"\r\n'.encode('utf-8'))
    print(receiving(ser))
    ser.write('AT+SMCONF="PASSWORD","DKERAFHA5AUPXX335F"\r\n'.encode('utf-8'))
    print(receiving(ser))
...
def init_comm():        #Module connect 
    ...
    if ser!='':
        ser.close()
    ser = serial.Serial("/dev/ttyUSB4",115200)  #SIM7000C serial port
    #ser = serial.Serial("/dev/ttyAMA0",115200) #Pi3,Pi4
